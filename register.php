			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						<div class="box-body">
							<center> <h5 style="font-family: Noto Sans;">Register as Student </h5><h4 style="font-family: Noto Sans;">Mind Fizz Quiz</h4></center><br>
							<form method="post" action="register.php" enctype="multipart/form-data">
                                <div class="form-group">
									<label  style="font-size:20px;">Enter Your Username:</label></br>
								...
								<div class="form-group">
									<label  style="font-size:20px;">Enter Your College Name:</label></br>
								...
								<div class="form-group text-center">
									<span class="text-muted">Already have an account! </span> <a href="Student.php">Login </a> Here..
								</div>
							</form>
						</div>
					</div>
